...
public class CompanyServiceImplTest {
    ...
    void testDeleteCompany() {
        ...
        verify(companyRepository, times(1)).findById(companyCode);
        verify(stockPriceRepository, times(1)).deleteById(company.getCompanyCode());
        verify(companyRepository, times(1)).deleteById(companyCode);
    }
    ...
    void testDeleteCompanyNotFound() {
        ...
        verify(companyRepository, times(1)).findById(companyCode);
        verify(stockPriceRepository, never()).deleteById(anyLong());
